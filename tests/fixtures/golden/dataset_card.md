...
Blog post: [How to describe a place on Earth with Wikidata](https://noeflandre.com/posts/describe-place-on-earth-part1-wikidata).
...
This Hugging Face dataset is **V1**, produced by the [V1.0.0 GitHub code](https://github.com/NoeFlandre/osm-polygon-wikidata-only/tree/v1.0.0).
