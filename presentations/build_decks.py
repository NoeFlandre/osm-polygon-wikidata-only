...
def _dataset_worldwide_osm_polygons(s: DatasetSnapshot) -> str:
    return f"""\
...
def _dataset_every_row_starts(s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: title-left -->
...
def _dataset_seven_parquet_tables(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _dataset_wikidata_bridge_between(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: title-left -->
...
def _dataset_snapshot_has_broad(s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _dataset_text_coverage_strongest(s: DatasetSnapshot) -> str:
    continent_rows = "\n".join(
...
def _dataset_languages_show_long(s: DatasetSnapshot) -> str:
    language_rows = "\n".join(
...
def _dataset_two_maps_answer(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _dataset_h3_density_shows(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _dataset_reproducible_snapshot_ready(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: title-left -->
...
def _dataset_grows_through(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: title-left -->
...
_DATASET_SLIDES: tuple[Callable[[DatasetSnapshot], str], ...] = (
    _dataset_worldwide_osm_polygons,
    _dataset_every_row_starts,
    _dataset_seven_parquet_tables,
    _dataset_wikidata_bridge_between,
    _dataset_snapshot_has_broad,
    _dataset_text_coverage_strongest,
    _dataset_languages_show_long,
    _dataset_two_maps_answer,
    _dataset_h3_density_shows,
    _dataset_reproducible_snapshot_ready,
    _dataset_grows_through,
)
...
def _dataset_deck(s: DatasetSnapshot) -> str:
    return (
        ...
        + "\n"
        + "---\n\n".join(slide(s) for slide in _DATASET_SLIDES)
    )


def _codebase_modular_resumable_enrichment(_s: DatasetSnapshot) -> str:
    return f"""\
...
def _codebase_system_layered_so(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: title-left -->
...
def _codebase_core_processing_has(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _codebase_wikimedia_access_shared(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _codebase_augmentation_turns_documents(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _codebase_recovery_migration_protect(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: title-left -->
...
def _codebase_publication_converges_local(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
...
def _codebase_quality_tools(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: content -->
## quality tools
...
def _codebase_start_command_follow(_s: DatasetSnapshot) -> str:
    return f"""\
<!-- layout: title-left -->
...
_CODEBASE_SLIDES: tuple[Callable[[DatasetSnapshot], str], ...] = (
    _codebase_modular_resumable_enrichment,
    _codebase_system_layered_so,
    _codebase_core_processing_has,
    _codebase_wikimedia_access_shared,
    _codebase_augmentation_turns_documents,
    _codebase_recovery_migration_protect,
    _codebase_publication_converges_local,
    _codebase_quality_tools,
    _codebase_start_command_follow,
)
...
def _codebase_deck(s: DatasetSnapshot) -> str:
    return (
        ...
        + "\n"
        + "---\n\n".join(slide(s) for slide in _CODEBASE_SLIDES)
    )
