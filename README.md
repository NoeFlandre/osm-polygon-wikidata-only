...
* Long enrichment stages emit a concise two-minute heartbeat with completed and
  total Wikidata QIDs, completed and total Wikipedia sites, and articles attempted.
  The snapshot confirms liveness; it is not an ETA and does not change request pacing.
  Short enrichment stages finish without a heartbeat.
