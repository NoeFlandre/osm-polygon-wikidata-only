...
def render_dataset_card(
    *,
    ...
    body = (
        ...
        "Denominator is every dataset polygon (already conditional on an OSM "
        "`wikidata=*` tag); colour is the share of polygons linked to at least "
        "one Wikipedia article with non-empty text. Cell opacity encodes polygon "
        "count on a log scale, and grey cells hold fewer than 20 polygons and "
