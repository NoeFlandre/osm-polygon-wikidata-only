...
def render_dataset_card(
    *,
    ...
    body = (
        ...
        "This is the V1 dataset, generated by the Wikidata-first V1 contract in "
        f"the [V1 code on GitHub]({V1_GITHUB_URL}). V1 selects polygons with a "
        "valid `wikidata=*` reference. The separate V2 dataset adds direct "
        "multilingual `wikipedia=*` discovery without changing this V1 dataset.\n\n"
        f"{trackio_block}\n"
        "## Coverage\n\n"
